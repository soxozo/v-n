...
<svg width="25px" height="25px" viewBox="0 0 0.5 0.5" xmlns="http://www.w3.org/2000/svg" fill="none">
    ...
    <nav
      ...
      >
        ...
        <Link href="#profile" passHref className="flex aspect-square min-h-[32px] w-16 flex-col items-center justify-center gap-1 rounded-md p-1.5 bg-indigo-50 text-indigo-600 dark:bg-sky-900 dark:text-sky-50">
        ...
        {/* Analytics Link */}
        <Link href="#analytics" passHref className="flex aspect-square min-h-[32px] w-16 flex-col items-center justify-center gap-1 rounded-md p-1.5 text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-slate-800">
          {/* HeroIcon - Chart Bar */}
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
        ...
        {/* Settings Link */}
        <Link href="#settings" passHref className="flex aspect-square min-h-[32px] w-16 flex-col items-center justify-center gap-1 rounded-md p-1.5 text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-slate-800">
          {/* HeroIcon - Cog */}
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
        ...
        {/* Home Link */}
        <Link href="/" passHref className="flex h-16 w-16 flex-col items-center justify-center gap-1 text-fuchsia-900 dark:text-gray-400">
          {/* HeroIcon - Home */}
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
