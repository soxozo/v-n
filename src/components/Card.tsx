...
import { TypesOfProfiles } from '@/types';
import Image from 'next/image';
import Link from 'next/link';


const Card: React.FC<TypesOfProfiles> = ({ id, name, surname, booking, position, picUrl, age, status }) => {
...
<div className="rounded-lg bg-white p-1">
  ...
  <div className="flex items-center justify-between">
    ...
    <img className="w-12 ring-2 rounded-full m-2 md:block" src={picUrl} alt="" />
      <div>

        <h3 className="text-base font-semibold text-gray-900">{name} {surname}</h3>
  ...
  <p className="my-2 text-sm font-normal text-gray-500">Hi, I'm Jessica Jane. I am a doctoral student at Harvard University majoring in Web . . .</p>
...
<svg fill="#000000" width="12px" height="12px" viewBox="0 0 0.54 0.54" version="1.1" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink"><title>flag-line</title><path className="clr-i-outline clr-i-outline-path-1" d="M0.09 0.51A0.015
