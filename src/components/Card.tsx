...
import { CandidateList } from '@/types/details';


const Card: React.FC<CandidateList> = ({ id, name, surname, email, mobile }) => {
  return (
  ...
  <div className="flex items-center justify-between">
    <div className="flex items-center">
      ...
      <div>
        ...
        <span className="block text-xs font-normal text-gray-500">{surname}</span>
      </div>
    </div>
